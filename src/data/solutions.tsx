  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text-xl">
          «GQ Group» предлагает множество готовых вариантов и
    ...
    content: (
      <>
        <p>
          ...
          специальных сооружений. Продукты, разработанные «GQ Group», могут
          улучшить обстановку в начальных школах и университетах, а также
          обеспечить безопасность учащихся.
        </p>
        <div className="relative w-full h-[400px]">
          <Image
            fill
        ...
        <p>
          Преимущества выбора GQ Group: <br />
